...
abstract class Recurring_Utils_Hook {
  ...
  static function alterRecurringContributionParams( &$recurParams ) {
    return self::singleton( )->invoke( 1, $recurParams, self::$_nullObject, self::$_nullObject, self::$_nullObject, self::$_nullObject, 'civicrm_alterRecurringContributionsQuery' );
  }
}
